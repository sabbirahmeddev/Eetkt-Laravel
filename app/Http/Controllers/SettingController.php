...
class SettingController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $settingGroups = SettingGroup::pluck('name', 'id');

        return view('app.settings.create', compact('settingGroups'));
    }
    ...
    public function edit(Request $request, Setting $setting)
    {
        ...
        return view('app.settings.edit', compact('setting', 'settingGroups'));
    }
