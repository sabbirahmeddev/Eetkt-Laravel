...
<head>
    ...
    <style>
        ...
        table .btn:not(.btn-outline):not(.btn-dashed):not(.border-hover):not(.border-active):not(.btn-flush):not(.btn-icon) {
        ...
        .searchbar .text-right .btn {
            float: right;
        }

        .card-title a i.icon:hover {
            transition: 0.3s;
            background: #1e1e2d;
            color: #fff;
