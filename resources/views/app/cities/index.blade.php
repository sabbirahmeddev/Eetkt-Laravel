    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">@lang('crud.cities.index_title')</h4>
            </div>
                ...
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left">
                                @lang('crud.cities.inputs.image')
                            </th>
                            <th class="text-left">
                                @lang('crud.cities.inputs.country_id')
                            </th>
                            <th class="text-left">
                                @lang('crud.cities.inputs.description')
                            </th>
                        ...
                        <tr>
                            ...
                            <td>
                                <x-partials.thumbnail
                                    src="{{ $city->image ? \Storage::url($city->image) : '' }}"
                                />
                            </td>
