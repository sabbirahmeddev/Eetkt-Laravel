...
class SocialLinkControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_social_links()
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_social_link()
    {
     ...
     * @test
     */
    public function it_stores_the_social_link()
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_social_link()
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_social_link()
    {
        $socialLink = SocialLink::factory()->create();
     ...
     * @test
     */
    public function it_updates_the_social_link()
    {
        $socialLink = SocialLink::factory()->create();
     ...
     * @test
     */
    public function it_deletes_the_social_link()
    {
        $socialLink = SocialLink::factory()->create();
