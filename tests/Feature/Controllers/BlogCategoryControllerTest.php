...
class BlogCategoryControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_blog_categories()
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_blog_category()
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_blog_category()
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_blog_category()
    {
        $blogCategory = BlogCategory::factory()->create();
